...
class Mail implements MailInterface
{
    ...
    /**
     * @var string
     * @ORM\Column(name="body_plaintext", type="text")
     */
    ...
    public function __construct($subject, $body, array $recipients)
    {
        ...
        $this->body = $body;
        if ($recipients[0] instanceof Address) {
            $recipients = array_map(static function ($address) {
    ...
    {
        return empty($this->attachments) ? [] : explode('|', $this->attachments);
    }
    ...
    {
        $this->attachments = empty($attachments) ? null : implode('|', $attachments);
    }
    ...
    public function addAttachement(string $attachement)
    {
        ...
        $this->attachments[] = implode('|', $attachements);
    }
